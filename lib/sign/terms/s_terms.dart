        ...
        child: SingleChildScrollView(
          child: RichText(
            text: const TextSpan(
              ...
              children: [
                TextSpan(
                  text: "MapTravel에 오신 것을 환영합니다!\n\n",
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                TextSpan(
                  text:
                      "저희가 명시적으로 별도의 약관(본 약관이 아님)이 적용된다고 밝히지 않는 한 본 이용 약관(또는 '약관')이 회원님의 MapTravel 사용에 적용되며 아래 설명된 MapTravel 서비스('서비스')에 대한 정보를 제공합니다. 회원님이 MapTravel 계정을 만들거나 MapTravel을 이용하는 경우, 회원님은 본 약관에 동의하는 것으로 간주됩니다.\n\n",
                ),
                TextSpan(
                  text: "MapTravel 서비스\n",
                  style: TextStyle(fontWeight: FontWeight.bold),
                ...
                TextSpan(
                  text:
                      "저희는 회원님에게 MapTravel 서비스를 제공하는 것에 동의합니다. 서비스에는 저희가 MapTravel의 사명을 실현하기 위해 제공하는 모든 MapTravel 제품, 기능, 앱, 서비스, 기술, 소프트웨어가 포함됩니다. MapTravel은 회원님이 사랑하는 사람들과 사항들을 더 가까이 접할 기회를 마련하는 것을 사명으로 삼습니다. 서비스는 다음과 같은 부분으로 구성됩니다.\n\n",
                ),
                TextSpan(
                  text: "여행 계획 공유\n",
                  style: TextStyle(fontWeight: FontWeight.bold),
                ...
                TextSpan(
                    text:
                        "자신만의 여행을 공유하고, 다른 사람들의 여행을 공유받습니다. 이 과정을 지도로 한 번에 볼 수 있도록 서비스를 제공합니다.\n\n"),
                TextSpan(
                  text: "MapTravel 서비스의 재정 조달 방식\n",
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                TextSpan(
                  text:
                      "MapTravel의 사용료를 지불하지 않는 대신, 본 약관이 적용되는 서비스를 사용함으로써, 회원님은 비즈니스 및 단체들이 홍보를 위해 저희에게 비용을 지불한 광고를 MapTravel 제품 내외부에서 보게 될 수 있다는 것을 인정합니다. 저희는 회원님에게 회원님과 관련성이 높은 광고를 보여드리기 위해 회원님의 활동 및 관심사에 대한 정보 등 회원님의 개인정보를 활용합니다.\n\n",
                ),
                TextSpan(
                  text:
                ...
                TextSpan(
                  text:
                      "저희는 또한 사람들이 MapTravel 내부와 외부에서 광고주의 콘텐츠와 어떻게 상호작용하고 있는지 광고주들이 이해할 수 있도록 광고주들에게 광고의 성과 보고서를 제공합니다. 예를 들어 광고주가 광고의 타겟을 더 잘 이해할 수 있도록 저희는 일반적 인구 통계 정보 및 관심사 정보를 광고주에게 제공할 수 있습니다. 저희는 회원님이 구체적으로 허락하지 않는 한 회원님을 직접적으로 식별할 수 있는 정보(이름, 또는 이메일 주소와 같이 그 정보만으로 회원님께 연락을 취하는 데 사용될 수 있거나 회원님을 식별할 수 있는 정보)를 공유하지 않습니다.\n\n",
                ),
                TextSpan(
                  text:
                      "콘텐츠에 언급되어 있는 비즈니스 파트너와의 상업적 관계를 기반으로 제품 또는 서비스를 홍보하는 계정의 소유자가 게시한 브랜디드 콘텐츠가 MapTravel에 표시될 수 있습니다. 이와 관련해서는 여기에서 자세히 알아보세요.\n\n",
                ),
                TextSpan(
                  children: [
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                            text: 'MapTravel을 이용할 수 있는 주체\n',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        TextSpan(text: '   - 만 14세 이상이어야 합니다.\n'),
                        TextSpan(
                            text:
                                '   - 관련 법률에 따라 MapTravel 서비스를 받는 것이 일부라도 금지된 사람 또는 관련 제재 대상 명단에 있어 결제 관련 MapTravel 서비스를 이용하는 것이 금지된 사람이 아니어야 합니다.\n'),
                        TextSpan(
                            text:
                                '   - 과거에 저희가 회원님의 계정을 법률 또는 MapTravel 정책 위반을 이유로 하여 비활성화한 적이 없어야 합니다.\n'),
                        TextSpan(text: '   - 유죄 확정판결을 받은 성범죄자가 아니어야 합니다.\n\n'),
                        TextSpan(
                            text: 'MapTravel을 사용할 수 없는 경우\n',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        TextSpan(
                            text: '   - 다른 사람을 사칭하거나 부정확한 정보를 제공하면 안 됩니다.\n'),
                        TextSpan(
                            text:
                                '   - MapTravel에서 회원님의 신원을 공개할 필요는 없지만, 회원님은 저희에게 정확한 최신 정보(등록 정보 포함)를 제공해야 하며 개인정보를 제공해야 할 수도 있습니다. 또한 본인이 아닌 다른 사람이나 단체를 사칭해서는 안 되며, 다른 사람의 명시적인 허락 없이 다른 사람의 이름으로 계정을 만들 수 없습니다.\n'),
                        TextSpan(
                            text:
                                '   - 불법적이거나, 오해의 소지가 있거나, 사기적인 행위 또는 불법적이거나 허가받지 않은 목적을 위한 어떠한 행위도 하면 안 됩니다.\n'),
                        TextSpan(
                            text:
                                '   - 특히 회원님은 MapTravel 커뮤니티 가이드라인, MapTravel 이용 약관 및 개발자 정책, 음악 가이드라인을 포함하여 본 약관 또는 저희 정책을 위반할 수 없으며, 다른 사람들이 이를 위반하도록 돕거나 조장해서도 안 됩니다.\n'),
                        TextSpan(
                            text:
                                '   - 브랜디드 콘텐츠를 게시하는 경우 회원님은 저희의 브랜디드 콘텐츠 정책을 준수해야 하며, 이에 따라 저희의 브랜디드 콘텐츠 도구를 사용해야 합니다. 행동 또는 콘텐츠를 신고하는 방법은 고객 센터에서 알아보세요.\n\n'),
                        TextSpan(
                            text: '서비스의 정상적인 운영을 방해하지 않기\n',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        TextSpan(
                            text:
                        ...
                        TextSpan(
                            text: '지식재산권 및 다른 사람의 권리를 존중하기\n',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        TextSpan(
                            text:
                                '   - 회원님은 다른 사람의 사생활 정보 또는 기밀 정보를 허가 없이 게시할 수 없으며 지식재산권을 포함하여 다른 사람의 권리를 침해하는 행위를 하여서는 안 됩니다.\n'),
                        TextSpan(
                            text:
                                '   - 회원님은 관련법의 저작권 및 관련 권리에 관한 예외 또는 제한 사항에 따라 다른 사람의 저작물을 사용할 수 있습니다. 회원님은 콘텐츠를 게시하거나 공유하기 위한 모든 권리를 소유하고 있거나 얻었음을 진술합니다.\n'),
                        TextSpan(
                            text:
                        ...
                        TextSpan(
                          text:
                              '회원님은 저희에게 회원님의 사용자 이름, 프로필 사진 및 회원님의 활동(예: \'좋아요\') 또는 관계(예: \'팔로우\')에 관한 정보를 MapTravel 제품 전반에 표시되는 계정, 광고, 제안 및 회원님이 팔로우하거나 참여하는 기타 홍보 콘텐츠와 함께 또는 이와 관련하여 표시할 수 있는 권한을 무상으로 부여합니다. 예를 들어, 저희는 회원님이 MapTravel에 유료로 광고를 게재하는 브랜드의 홍보 게시물에 좋아요를 눌렀다는 점을 표시할 수 있습니다. 다른 콘텐츠에서의 행동 및 다른 계정에 대한 팔로우와 마찬가지로, 홍보 콘텐츠에서의 행동 및 홍보 계정에 대한 팔로우도 해당 콘텐츠나 팔로우를 볼 수 있는 권한이 있는 사람들에게만 표시됩니다. 저희는 회원님의 광고 설정 또한 존중합니다. 여기에서 회원님의 광고 설정에 대해 자세히 알아보실 수 있습니다.\n\n',
                        ),
                        TextSpan(
                          text:
                      ...
                      style: TextStyle(
                          fontSize: 14.0,
                          color: Colors.black), // 스타일은 필요에 따라 수정하세요
                    ),
                  ],
                ),
                TextSpan(
                ...
                TextSpan(
                  children: [
                    TextSpan(
                      text: '콘텐츠 삭제 및 계정 비활성화 또는 해지\n\n',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    TextSpan(
                      text:
                          '회원님이 서비스에서 공유하는 콘텐츠나 정보가 본 이용 약관, 저희 정책(저희 MapTravel 커뮤니티 가이드라인 포함)에 위배된다고 판단되거나 법에 따라 삭제해야 할 경우, 저희는 이를 삭제할 수 있습니다. 저희는 저희 커뮤니티 또는 서비스를 보호하기 위해 또는 회원님이 저희에게 위험 또는 법적 문제를 일으키거나, 본 약관 또는 저희 정책(저희 MapTravel 커뮤니티 가이드라인 포함)을 위반하거나, 다른 사람의 지식재산권을 반복적으로 침해하거나, 법률에 따라 허용되거나 요구되는 경우에 회원님에게 서비스 전부 또는 일부를 제공하는 것을 즉시 중단하거나 거부할 수 있습니다(회원님의 MapTravel 제품 및 MapTravel 제품 액세스 해지 또는 비활성화 포함). 저희에게 법적으로 불리하거나 규제적 영향을 끼치는 상황을 피하거나 줄이기 위해 필요하다고 합리적으로 판단되면, 저희는 서비스를 해지 또는 변경하거나, 서비스에서 공유된 콘텐츠 또는 정보를 삭제 또는 차단하거나, 서비스 전부 또는 일부를 제공하는 것을 중단할 수 있습니다. 회원님의 계정이 오류로 인해 해지되었다고 생각되는 경우 또는 회원님의 계정을 비활성화하거나 영구 삭제하고 싶은 경우에는 저희 고객 센터로 문의하세요. 콘텐츠 또는 계정의 삭제를 요청하는 경우 삭제 프로세스는 요청 후 30일 이내에 자동으로 시작됩니다. 삭제 프로세스가 시작된 후 콘텐츠 삭제에는 최대 90일이 걸릴 수 있습니다. 이러한 콘텐츠 삭제 프로세스가 진행되는 동안 콘텐츠는 사용자에게 표시되지 않지만 계속해서 본 이용 약관 및 개인정보처리방침의 적용을 받습니다. 콘텐츠가 삭제된 후에는 백업과 재난 복구 시스템에서 삭제하는 데 최대 90일이 더 걸릴 수 있습니다.\n\n'
                          '다음과 같은 경우 콘텐츠는 계정 삭제 후 또는 콘텐츠 삭제 프로세스가 시작된 후 90일 이내에 삭제되지 않습니다.\n'
                          '1. 다른 사람이 이 라이선스에 따라 콘텐츠를 사용하였고 아직 삭제하지 않은 경우(이 경우 콘텐츠가 삭제될 때까지 해당 라이선스가 계속 적용됨) 또는\n'
                          '2. 저희 시스템의 기술적 제한으로 인해 90일 이내 삭제가 가능하지 않은 경우(그리고 그러한 경우 저희는 기술적으로 가능해지는 즉시 콘텐츠를 삭제함) 또는\n'
                          '3. 즉시 삭제하면 다음과 같은 저희의 조치가 제한될 수 있는 경우\n'
